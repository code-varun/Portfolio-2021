...
function SkeletonLoader(_a) {
    ...
    return (React__default["default"].createElement("div", { className: css.skeleton, style: __assign({ width: width, height: height, background: background, borderRadius: circle ? "50%" : radius, display: block ? "block" : "inline-block" }, style) }, "\u200C"));
}
